...
const int Member = 8;
int Input[Member] = { 0 };
//long long int Output[Member] = { 0 };
//int Output[Member] = { 15, 1, 12, 3, 5, 6, 8, 7, 0, 10, 13, 9, 2, 4, 14, 11 };
int Output[Member] = {7,6,1,3,4,0,2,5};
//int Output[Member] = { 2,3,1,0 };
//int Output[Member] = { 0 ,5 ,1 ,3 ,4 ,6 ,2, 7 };// 4 5 2 3 0 6 1 7
//int Output[Member] = { 2 ,6 ,0 ,3 ,1 ,5 ,7 ,4 };
